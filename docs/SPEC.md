...
1. Analisar métricas baixas e identificar problemas
2. Editar prompt, fazer push e avaliar novamente
3. Repetir até **TODAS as métricas >= 0.8**
...
Edite o arquivo `tests/test_prompts.py` e implemente, no mínimo, os 6 testes abaixo usando pytest:
...
Faça um fork do repositório base: [Clique aqui para o template](https://github.com/leonanluppi/mba-ia-pull-evaluation-prompt)
...
- [Repositório boilerplate do desafio](https://github.com/leonanluppi/mba-ia-pull-evaluation-prompt)
